...
input_folder = r"C:\Users\Yuktha Varshika\Music\Classified"
...
x = Dropout(0.3)(x)
output_layer = Dense(5, activation='softmax', name='disease_output')(x)  
...
model=load_model("Retinal_Disease_Classification.h5")
print("Model Saved Successfully")
model.save("retina_model")
model=tf.keras.models.load_model("retina_model")
